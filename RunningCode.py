...
# From these two Repayment Status plots, it is fair to say if in the last month i.e. September, if a person has payment delay for two months or more, then he's around 70% likely to default. But as we proceed to earlier months, people who have delays for more than six months are more likely to default.
